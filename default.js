(function() {
    ...
    if (navigator.userAgent.indexOf('Windows') !== -1 && (navigator.userAgent.indexOf('Trident') !== -1 || navigator.userAgent.indexOf('Edge') !== -1) && !isMobile.any()) {
        str = "Leandro Rabello Barbosa";
    }
